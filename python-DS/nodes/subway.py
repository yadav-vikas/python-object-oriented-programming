...
# "Times Square" to the head of the list
# "Grand Central" to the head of the list
# "Central Park" to the head of the list
...
#"Penn Station" to the tail of the list
#"Wall Street" to the tail of the list
#"Brooklyn Bridge" to the tail of the list
